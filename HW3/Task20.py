...
# symbol_dict = {1: 'aeioulnstrавеинорст', 2: 'dgдклмпу', 3: 'bcmpбгёья',
#                4: 'fhvwyйы', 5: 'kжэхцч', 8: 'jxшэю', 10: 'qzфщъ'}

symbol_dict = {'a': 1, 'e': 1, 'i': 1, 'o': 1, 'u': 1, 'l': 1, 'n': 1, 's': 1,
...
for ch in text:
    score += int(symbol_dict[ch])

print(f"Введенный текст оценивается на {score} очков")
